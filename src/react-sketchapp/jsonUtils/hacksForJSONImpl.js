...
export function makeResizeConstraint(resizingConstraint) {
...
export function createAttributedString(textNode) {
...
export function makeEncodedAttributedString(textNodes) {
...
export function makeTextStyle(textStyle) {
...
export function makeSvgLayer(layout, name, svg) {
